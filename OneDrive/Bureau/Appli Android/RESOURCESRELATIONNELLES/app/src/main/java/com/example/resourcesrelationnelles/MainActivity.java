    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()){
            ...
            case R.id.nav_ressources :
                Intent i1 = new Intent(MainActivity.this,Ressources.class);
                startActivity(i1);
                break;
            case R.id.text_rces_accueil:// Marche pas cas n'est pas dans le Menu de Navigation
                Intent i2 = new Intent(MainActivity.this,Ressources.class);
                startActivity(i2);
                break;

                // Redirection Connexion
            case R.id.nav_connexion:
                Intent i3 = new Intent(MainActivity.this,menuconnexion.class);
                startActivity(i3);
                break;
            case R.id.text_con_accueil:// Marche pas cas n'est pas dans le Menu de Navigation
                Intent i4 = new Intent(MainActivity.this,menuconnexion.class);
                startActivity(i4);
                break;
